...
You can access the complete reproduction data here: **[https://doi.org/10.5281/zenodo.18331985](https://doi.org/10.5281/zenodo.18331985)**

This dataset includes:
- **Input Trajectories:** Raw MD data for the Rigid (6CWG), Medium (1ZM4), and Difficult (2OT3) test cases.
- **Analysis Outputs:** Full sets of tables and figures generated by DynaPIN for these systems.
