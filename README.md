...
DynaPIN seamlessly integrates several powerful structural analysis tools and methodologies to perform comprehensive interface profiling. If you use DynaPIN in your research, please also consider citing the underlying software and definitions that make this pipeline possible:
